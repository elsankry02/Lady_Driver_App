...
/// generated route for
/// [ModifyPasswordPage]
class ModifyPasswordRoute extends PageRouteInfo<void> {
  const ModifyPasswordRoute({List<PageRouteInfo>? children})
      : super(
          ModifyPasswordRoute.name,
          initialChildren: children,
        );

  static const String name = 'ModifyPasswordRoute';
